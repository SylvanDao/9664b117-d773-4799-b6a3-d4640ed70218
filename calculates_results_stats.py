...
#                                                                             
# PROGRAMMER: TUNG DAO
# DATE CREATED: 5 AUG 2024                                 
# REVISED DATE: 5 AUG 2024
...
def calculates_results_stats(results_dic):
    ...
    # Sets all counters to initial values of zero so that they can be incremented
    ...
    # Returns the results_stats_dic dictionary that you created with this function
